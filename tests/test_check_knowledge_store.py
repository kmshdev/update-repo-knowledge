...
class CheckKnowledgeStoreAdapterTests(unittest.TestCase):
    ...
    def test_generated_marker_without_header_pointer_warns(self) -> None:
        write(
            self.repo / "CLAUDE.md",
            "\n".join(
                [
                    "<!-- Generated by a local tool. Do not edit directly. -->",
                    "Use pnpm test before changing docs.",
                    "Keep release notes in this adapter.",
                    "Document API changes here.",
                    "Preserve local runbook details here.",
                    "Do not update the root map for API-only changes.",
                    "Only this file mentions the deployment policy.",
                    "Use staging before production.",
                    "Keep product facts in this adapter.",
