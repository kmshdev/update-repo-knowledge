...
**Files:**
- Create: `/Users/kmsh/Researcher/update-repo-knowledge/tests/test_check_knowledge_store.py`
- Modify: `/Users/kmsh/Researcher/update-repo-knowledge/scripts/check_knowledge_store.py`
...
In `/Users/kmsh/Researcher/update-repo-knowledge/scripts/check_knowledge_store.py`,
...
**Files:**
- Modify: `/Users/kmsh/Researcher/update-repo-knowledge/references/intent-layer-capture.md`
- Modify: `/Users/kmsh/Researcher/update-repo-knowledge/SKILL.md`

- [ ] **Step 1: Update the adapter policy reference**

In `/Users/kmsh/Researcher/update-repo-knowledge/references/intent-layer-capture.md`,
...
In `/Users/kmsh/Researcher/update-repo-knowledge/SKILL.md`, under
...
```bash
cd /Users/kmsh/Researcher/update-repo-knowledge
uv run --script scripts/check_knowledge_store.py . --json
```
...
**Files:**
- Verify: `/Users/kmsh/Researcher/update-repo-knowledge/scripts/check_knowledge_store.py`
- Verify: `/Users/kmsh/Researcher/update-repo-knowledge/tests/test_check_knowledge_store.py`
- Verify: `/Users/kmsh/Researcher/update-repo-knowledge/SKILL.md`
- Verify: `/Users/kmsh/Researcher/update-repo-knowledge/references/intent-layer-capture.md`
...
cd /Users/kmsh/Researcher/update-repo-knowledge
uv run --with PyYAML \
  /Users/kmsh/.codex/skills/.system/skill-creator/scripts/quick_validate.py .
```
